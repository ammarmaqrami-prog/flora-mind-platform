...
export default function VoiceAIPage() {
  const [messages, setMessages] = useState<{ role: "user" | "assistant"; content: string; images?: string[]; isError?: boolean }[]>([
    { role: "assistant", content: "مرحباً! أنا مساعدك الصوتي. يمكنك التحدث مباشرة لشرح مشكلة نباتك، وسأقوم بتحويل كلامك إلى نص، ثم تحليله وإعطائك خطة علاجية مكتوبة بالتفصيل. يمكنك أيضاً رفع صور لدعم التشخيص." },
  ]);
    ...
    try {
      ...
      const res = await fetch("/api/chat", {
        ...
        body: JSON.stringify({
          message: "",
          images: [],
          featureName: "الذكاء الاصطناعي للتسجيل الصوتي",
  ...
  const startVoiceRecording = () => {
    ...
    recognition.continuous = true; // للسماح بجمل طويلة
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-12">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-green-900">الذكاء الاصطناعي للتسجيل الصوتي والكتابة الزراعية</h1>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-md mb-10 border border-green-100">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            <strong>المشكلة:</strong> كثير من المزارعين يجدون صعوبة في شرح مشاكلهم الزراعية كتابةً، مما يؤدي إلى سوء فهم وتشخيص غير دقيق.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
            <strong>كيف تعمل؟</strong> تحدث مباشرة عن مشكلة نباتك (مثلاً "أوراق الطماطم تذبل رغم الري المنتظم"). سيقوم الذكاء الاصطناعي بتحويل كلامك إلى نص منظم، ثم يحلله ويعطيك تشخيصاً دقيقاً وخطة علاج مكتوبة خطوة بخطوة. يمكنك أيضاً إرفاق صور لدعم التحليل.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
            <strong>الفوائد:</strong> سهولة الاستخدام للمبتدئين، فهم أدق للمشكلة، وتحويل الأفكار العشوائية إلى حلول منظمة.
          </p>
        ...
        <div className="bg-gradient-to-br from-green-50 to-sky-50 rounded-2xl p-6 md:p-8 mb-12 border border-green-200">
          <h2 className="text-2xl font-bold text-green-900 mb-4">💡 نصائح للتسجيل الصوتي الفعّال</h2>
          <ul className="space-y-3 text-gray-700">
            <li>🎤 تحدث بوضوح وبسرعة معتدلة، واذكر نوع النبات والأعراض بالتفصيل.</li>
            <li>📸 ارفع صوراً للأجزاء المصابة لتحليل أدق.</li>
            <li>📝 يمكنك أيضاً كتابة ملاحظات إضافية لتحسين النتيجة.</li>
          </ul>
        </div>
        ...
        <div className="relative">
          ...
          <h3 className="text-xl font-bold text-green-800 mb-2 text-center">تحدث مع المساعد الصوتي</h3>
          <div className="bg-white rounded-2xl shadow-xl border border-green-200 overflow-hidden" ref={chatContainerRef}>
            ...
            <div className="border-t border-gray-200 p-4 flex items-center gap-2 bg-white">
              ...
              <input
                ...
                placeholder={isRecording ? "🎙️ جاري الاستماع..." : "اكتب ملاحظاتك أو تحدث..."}

...
export default function PlantScanPage() {
  const [messages, setMessages] = useState<{ role: "user" | "assistant"; content: string; images?: string[]; isError?: boolean }[]>([
    { role: "assistant", content: "مرحباً! أنا مساعدك الزراعي. يمكنك سؤالي عن حالة نباتك، أو رفع صورة لتشخيص المرض، أو تسجيل رسالة صوتية." },
  ]);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-12">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-green-900">فحص نبتتك + المؤشر الآمن الزراعي</h1>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-md mb-10 border border-green-100">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            <strong>المشكلة:</strong> النباتات تمرض أو تضعف دون معرفة السبب إلا بعد فوات الأوان، مما يؤدي إلى انتشار المرض وتلف المحصول.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
            <strong>كيف تعمل؟</strong> ببساطة قم بتصوير نبتتك، وسيقوم نظامنا بتحليل الصورة باستخدام الذكاء الاصطناعي لتحديد المشكلة ويعطيك تشخيصاً دقيقاً مع مؤشر خطورة وخطوات علاج واضحة.
          </p>
        ...
        <div className="bg-gradient-to-br from-green-50 to-sky-50 rounded-2xl p-6 md:p-8 mb-12 border border-green-200">
          <h2 className="text-2xl font-bold text-green-900 mb-4">💡 نصائح للحصول على أفضل تشخيص</h2>
          <ul className="space-y-3 text-gray-700">
            <li>📷 التقط صورة واضحة للجزء المصاب.</li>
            <li>🌿 صور من زوايا متعددة.</li>
            <li>📅 أفضل وقت للتصوير: الصباح الباكر.</li>
            <li>🧪 أمراض شائعة في عُمان: البياض الدقيقي، لفحة الأوراق.</li>
          </ul>
        </div>

        {/* حالة الاستخدام المجاني / الاشتراك */}
        {!user && (
          <div className="mb-4">
            {isBlocked ? (
              <div className="bg-red-50 border border-red-200 text-red-800 p-3 rounded-xl text-center">
                ...
                للاستمتاع بفترة تجريبية 7 أيام.
              </div>
              ...
              <div className="bg-amber-50 border border-amber-200 text-amber-800 p-3 rounded-xl text-center">
                ...
                لاستخدام غير محدود لمدة 7 أيام.
              </div>
            ) : null}
          </div>
        )}
        ...
        <div className="relative">
          ...
          <h3 className="text-xl font-bold text-green-800 mb-2 text-center">تحدث مع المساعد الزراعي</h3>
